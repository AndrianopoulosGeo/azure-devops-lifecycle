...
Invoke via the **`Skill` tool with `skill: "commit"`**. Follow these rules:

- Use Conventional Commits format: `<type>(<scope>): <summary>`
- Group related changes into logical commits (don't lump everything into one)
- Reference Azure DevOps ticket IDs: `Refs: #[TASK_ID]` or `Refs: #[STORY_ID]`
- **NEVER include Co-Authored-By, Generated by, or any reference to Claude, Claude Code, AI, or Anthropic**
- **Commit messages must look entirely human-written**
